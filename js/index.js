...
const user = people.filter((x) => x.age != null);

// for (i = 0; i < user.length; i++) {
//   //   user[i].age.sort((a, b) => a - b);
...
// nurmukhamedov
// /
// javascript-lesson-nt101
// Public
// Fork your own copy of nurmukhamedov/javascript-lesson-nt101
// Code
// Issues
// Pull requests
// Actions
...
// Security
// Insights
// javascript-lesson-nt101/js/users.js /
// @nurmukhamedov
// nurmukhamedov lesson-38
// Latest commit 6115355 on Feb 18
//  History
//  1 contributor
// 602 lines (602 sloc)  32 KB
...
const card = users.map((element) => {
  return `
  <div class="box">
          <img class="card__img" src=${element.avatar_url}alt="" />
          <p class="card__text card__text-one">Login: ${element.login}</p>
          <p class="card__text">Id: ${element.id}</p>
          <p class="card__text">Account:<a class="card__link" href=${element.url}>GitHub</a></p>
        </div>
  `;
});

row.innerHTML = card.join("");
